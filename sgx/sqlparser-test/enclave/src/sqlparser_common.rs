...
pub fn parse_where_delete_statement() {
...
pub fn parse_limit_is_not_an_alias() {
...
pub fn parse_select_count_wildcard() {
...
pub fn parse_select_count_distinct() {
...
pub fn parse_invalid_infix_not() {
...
pub fn parse_select_string_predicate() {
...
pub fn parse_projection_nested_type() {
...
pub fn parse_escaped_single_quote_string_predicate() {
    use self::BinaryOperator::*;
    let sql = "SELECT id, fname, lname FROM customer \
...
pub fn parse_between_with_expr() {
    use self::BinaryOperator::*;
...
pub fn parse_select_order_by_limit() {
...
pub fn parse_limit_accepts_all() {
    one_statement_parses_to(
...
pub fn parse_create_table_with_options() {
...
pub fn parse_create_table_trailing_comma() {
...
pub fn parse_create_table_empty() {
    // Zero-column tables are weird, but supported by at least PostgreSQL.
    let _ = verified_stmt("CREATE TABLE t ()");
}


pub fn parse_alter_table_constraints() {
    ...
    pub fn check_one(constraint_text: &str) {
...
pub fn parse_scalar_function_in_projection() {
...
pub fn parse_aggregate_with_group_by() {
...
pub fn parse_literal_timestamp() {
...
pub fn parse_simple_math_expr_plus() {
    let sql = "SELECT a + b, 2 + a, 2.5 + a, a_f + b_f, 2 + a_f, 2.5 + a_f FROM c";
    verified_only_select(sql);
}


pub fn parse_simple_math_expr_minus() {
    let sql = "SELECT a - b, 2 - a, 2.5 - a, a_f - b_f, 2 - a_f, 2.5 - a_f FROM c";
    verified_only_select(sql);
}


pub fn parse_delimited_identifiers() {
...
pub fn parse_searched_case_expr() {
...
pub fn parse_natural_join() {
    pub fn natural_join(f: impl Fn(JoinConstraint) -> JoinOperator) -> Join {
        Join {
            relation: TableFactor::Table {
                name: ObjectName(vec!["t2".to_string()]),
                alias: None,
...
pub fn parse_complex_join() {
    let sql = "SELECT c1, c2 FROM t1, t4 JOIN t2 ON t2.c = t1.c LEFT JOIN t3 USING(q, c) WHERE t4.c = t1.c";
    verified_only_select(sql);
}


pub fn parse_join_nesting() {
...
pub fn parse_join_syntax_variants() {
    one_statement_parses_to(
...
pub fn parse_ctes() {
    ...
    pub fn assert_ctes_in_select(expected: &[&str], sel: &Query) {
        let mut i = 0;
        for exp in expected {
...
pub fn parse_cte_renamed_columns() {
...
pub fn parse_multiple_statements() {
    pub fn test_with(sql1: &str, sql2_kw: &str, sql2_rest: &str) {
...
// pub fn parse_scalar_subqueries() {
...
pub fn parse_create_view_with_options() {
...
pub fn parse_create_view_with_columns() {
...
pub fn parse_invalid_subquery_without_parens() {
...
pub fn parse_singular_row_offset() {
    one_statement_parses_to(
...
pub fn lateral_derived() {
    pub fn chk(lateral_in: bool) {
...
pub fn parse_start_transaction() {
...
// pub fn ensure_multiple_dialects_are_tested() {
...
pub fn verified_query(query: &str) -> Query {
...
pub fn verified_expr(query: &str) -> Expr {
