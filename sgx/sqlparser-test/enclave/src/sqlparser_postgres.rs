...
pub fn parse_insert_with_columns() {
...
pub fn parse_create_table_with_defaults() {
    let sql = String::from(
...
pub fn parse_create_table_from_pg_dump() {
    let sql = String::from("
        CREATE TABLE public.customer (
...
pub fn parse_create_table_with_inherit() {
    let sql = String::from(
        "\
...
pub fn parse_alter_table_constraint_primary_key() {
    let sql = String::from(
        "\
...
pub fn parse_alter_table_constraint_foreign_key() {
    let sql = String::from("\
...
pub fn parse_timestamps_example() {
...
pub fn parse_timestamps_with_millis_example() {
